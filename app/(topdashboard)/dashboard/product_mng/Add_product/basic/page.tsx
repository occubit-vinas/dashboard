...
const Page = () => {
    ...
    return (
        ...
        <div className='container my-10' onCreate={handleCreate} onCancel={handleCancel}>


            <div className='bg-white shadow-md rounded-xl flex flex-col gap-4 p-4 my-5'>
                {/* Row 1 */}
                <div className='flex flex-row gap-4 w-full'>
                    <div className='w-1/3'>
                        <label className='block text-first mb-2'>Name</label>
                        <input
                            type='text'
                            placeholder='Kurti'
                            value={formData.name}
                    ...
                    <div className='w-1/3'>
                        <label className='block text-first mb-2'>Parent Category</label>
                        <select
                    ...
                    <div className='w-1/3'>
                        <label className='block text-first mb-2'>Brand</label>
                        <input
                            type='text'
                ...
                <div className='flex flex-row gap-4 w-full'>
                    <div className='w-1/3'>
                        <label className='block text-first mb-2'>SKU</label>
                        <input
                            type='text'
                    ...
                    <div className='w-1/3'>
                        <label className='block text-first mb-2'>GST</label>
                        <input
                            type='text'
                    ...
                    <div className='w-1/3'>
                        <label className='block text-first mb-2'>HSN Code</label>
                        <input
                            type='text'
                ...
                <div className='flex flex-row gap-4 w-full'>
                    <div className='w-1/2'>
                        <label className='block text-first mb-2'>Description</label>
                        <textarea
                    ...
                    <div className='w-1/2'>
                        <label className='block text-first mb-2'>Category Image</label>
                ...
                <div className='flex flex-row gap-4'>
                    <div className='w-1/2'>
                        <label className='block text-first mb-2'>Tags</label>
                        <div className='light-purple rounded-lg shadow p-6 flex flex-col gap-4'>
                            ...
                            <div className='flex flex-col gap-2'>
                                <p className='text-second'>Tag Value</p>
                                <input
                                    type='text'
                    ...
                    {/* Specification */}
                    <div className='w-1/2'>
                        <label className='block text-first mb-2'>Specification</label>
                        <div className='light-purple rounded-lg shadow p-6 flex flex-col gap-4'>
                            <div className='flex flex-col gap-2'>
                            ...
                            <div className='flex flex-col gap-2'>
                                <p className='text-second'>Specification Value</p>
                                <input
                                    type='text'

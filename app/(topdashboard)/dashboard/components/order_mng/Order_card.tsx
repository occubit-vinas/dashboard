...
const Order_card = ({ setopencard }) => {
    return (
        <div className='bg-white rounded-sm p-4 flex flex-col gap-4 fixed right-20 top-20 w-[400px] z-50 shadow-xl '>
            <div className='flex flex-row justify-between'>
                ...
                <MdOutlineCancel className='size-5'  onClick={() => setopencard(false)} />
            </div>
            ...
            <div className='flex flex-row gap-2 justify-center'>
                <White_button label='Close' onClick={() => setopencard(false)} />
